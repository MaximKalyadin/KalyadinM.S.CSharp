...
namespace WindowsFormsGasolineTanker
{
    class Truck : BaseClassTruck
    {
        ...
        public Truck(int maxSpeed, float weight, Color mainColor, Color dopColor, bool vat, bool stairs, bool strip) : base (maxSpeed, weight, mainColor)
        {
            DopColor = dopColor;
            Vat = vat;
            Stairs = stairs;
